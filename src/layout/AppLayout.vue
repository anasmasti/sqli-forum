		...
		<nav class="bg-blue-500 border-gray-200 px-2 sm:px-4 py-2.5">
			<div class="container flex flex-wrap items-center justify-between mx-auto">
				<router-link to="/" class="flex items-center">
					<span class="self-center text-xl font-black whitespace-nowrap text-white">
					<span class="logo">SQLI</span>	 Forum
					</span>
				</router-link>
				<div class="flex items-center md:order-2">
					<div v-if="isLoggedIn" class="flex justify-end">
						<router-link :to="{
							...
							<img class="w-9 h-9 rounded-full border border-solid border-white" src="https://cdn-icons-png.flaticon.com/512/149/149071.png"
								alt="user photo">
							<div>
